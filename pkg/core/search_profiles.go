...
var (
	...
	ErrUnsuportedSearchProfiles = errors.New("param must be one between 'source', 'sort', 'search' and 'limit'")
)
...
func NewSearchProfilesArgs(pubkey string) SearchProfilesArgs {
	return SearchProfilesArgs{
		Algorithm: Algorithm{
			Sort:   Global,
			Source: pubkey,
		},
